...
+ (id)plusButton{
    ...
    [capPlusButton addTarget:capPlusButton action:@selector(clickStartCap) forControlEvents:UIControlEventTouchUpInside];
...
- (void)clickStartCap{
    ...
    CapVC.view.backgroundColor = [UIColor redColor];
    [viewController presentViewController:CapVC animated:YES completion:nil];
